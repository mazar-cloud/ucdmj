    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-9 col-md-8">
            <div class="row pb-3">
                <?php
                // print_r($_GET);
                    if (isset($_GET['name']) && $_GET['name'] == "subcategory") {
                        $subcategoryid = $_GET['sub_category_id'];
                        $sql = "SELECT * FROM products WHERE SubCategoryID = '{$db->escape($subcategoryid)}'";
                        $result = $db->query($sql);
                ...
                <?php
                    ...
                    } elseif(isset($_GET['name']) && $_GET['name'] == "category") {
                        $categoryid = $_GET['category_id'];
                        $sql = "SELECT * FROM products WHERE CategoryID = '{$db->escape($categoryid)}'";
                        $result = $db->query($sql);
                        if ($db->num_rows($result) > 0) {
                            while($product = $db->fetch_assoc($result)) {
                ?>
